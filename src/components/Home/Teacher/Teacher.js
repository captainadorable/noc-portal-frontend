    ...
    const Status_card = (props) => {
        return (
            <div className="flex flex-col space-y-2">
                ...
                <h1 className="text-2xl text-center">{props.ders} tane <span className="text-white">ders</span> </h1>
    ...
    return(
       <Layout>         
            <div className="pt-32 px-10 flex flex-col space-y-20">
                <div className="px-20 text-xl text-[#7a94f3] flex flex-row space-x-2">
                ...
                <div className="flex flex-col space-y-10 justify-center items-center">
                    ...
                    <div className="bg-[#182044] w-full p-6 rounded-xl grid grid-flow-col grid-rows-1 place-items-center text-white">
                        <Status_card name="Cebirsel ifadeler" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="23" dk="200"/>
                        <Status_card name="Üçgenler" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="12" dk="185"/>
                        <Status_card name="Dörtgenler" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="32" dk="69"/>
                        <Status_card name="Trigonometri" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="11" dk="101" />
                        <Status_card name="Limit" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="5" dk="123" />
                        <Status_card name="Türev" color1="text-[#3b82f6]" color2="text-[#3d6cff]" ders="9" dk="154" />
                    </div>
                    ...
                    <div className="grid grid-rows-1 gap-4 grid-flow-col place-items-center">
                        <Lastthree photo="https://pbs.twimg.com/profile_images/1151410974240444416/yVvaD7hU_400x400.jpg" name="Allsowp11" color="text-yellow-500" lesson="fonksiyonlar" time="20:23" date="01.01.2023"/>
                        <Lastthree photo="https://pbs.twimg.com/profile_images/1151410974240444416/yVvaD7hU_400x400.jpg" name="Allsowp11" color="text-green-500" lesson="üçgende diklik" time="20:23" date="01.01.2023"/>
                        <Lastthree photo="https://pbs.twimg.com/profile_images/1151410974240444416/yVvaD7hU_400x400.jpg" name="Allsowp11" color="text-blue-500" lesson="dış bükey üçgen" time="20:23" date="01.01.2023"/>
                    </div>
