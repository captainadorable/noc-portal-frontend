...
export const RoomCard = ({ Room }) => {
    ...
    return (
        <form onSubmit={() => navigate(`${Room.id}`)} className="flex flex-col items-center justify-between space-y-4 bg-blue-200 py-4 h-36 w-48 text-white rounded-2xl shadow">
